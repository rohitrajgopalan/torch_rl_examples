from pettingzoo.classic import texas_holdem_v3, texas_holdem_no_limit_v4
import os
...
def run_hill_climbing(env, env_name, penalty):
    ...
    for enable_action_blocker in list({False, penalty > 0}):
        ...
        for use_ml_for_action_blocker in use_ml_flags:
            ...
            agents = {env.possible_agents[0]: agent, env.possible_agents[1]: RandomLegal()}
...
run_hill_climbing(env, 'texas_holdem', 1)
env = texas_holdem_no_limit_v4
run_all_td_methods(env, 'texas_holdem_no_limit', 1)
run_hill_climbing(env, 'texas_holdem_no_limit', 1)
